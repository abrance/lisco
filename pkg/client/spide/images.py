...
from . import utils
from .jimeng_core import request, DEFAULT_ASSISTANT_ID, DEFAULT_MODEL, DRAFT_VERSION, MODEL_MAP
...
def build_abilities(prompt, image_uri, _model, sample_strength, height, width, negative_prompt):
    dc = {
        "type": "",
    ...
    if image_uri:
        dc["blend"] = build_abilities_by_generate_type(prompt, image_uri, _model, sample_strength, height, width, negative_prompt)
    else:
        dc["generate"] = build_abilities_by_generate_type(prompt, image_uri, _model, sample_strength, height, width, negative_prompt)
    return dc


def build_abilities_by_generate_type(prompt, image_uri, _model, sample_strength, height, width, negative_prompt):
    dc = {
        "generate": {
            "type": "",
            "id": utils.generate_uuid(),
